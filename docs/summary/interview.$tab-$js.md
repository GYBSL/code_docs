...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-21-1.png)
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-21-2.png)
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-21-3.png)
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-21-4.png)
...
- js数组常用方法总结
  ...
  - concat()
    ...
    用于连接两个或多个数组, 返回新数组。该方法不会改变现有的数组，而仅仅会返回被连接数组的一个副本。
  ...
  - filter()
    ...
    挑选数组中符合条件的并返回符合要求的新数组，filter()不会对空数组进行检测、不会改变原始数组
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-23-1.png)
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-23-2.png)
...
![](https://gitee.com/gybsl/image-upload/raw/master/image_docs/js-5-27-1.png)
